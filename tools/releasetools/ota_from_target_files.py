...
""" % bcb_dev)
  ...
  #Print ASCII
  script.Print(" ");
  script.Print("     _____       __              _          ");
  script.Print("    / ___/__  __/ /_  ___  _____(_)___ _    ");
  script.Print("    \__ \/ / / / __ \/ _ \/ ___/ / __ `/    ");
  script.Print("   ___/ / /_/ / /_/ /  __/ /  / / /_/ /     ");
  script.Print("  /____/\__, /_.___/\___/_/  /_/\__,_/      ");
  script.Print("       /____/                               ");
  script.Print(" ");
  script.Print(" ");
  ...
  if OPTIONS.backuptool:
    ...
    script.Mount("/system")
    script.RunBackup("backup", "/system/system" if is_system_as_root and common.system_as_system else "/system")
  ...
  if target_info.GetBuildProp("ro.syberia.display.version") is not None:
    buildid = target_info.GetBuildProp("ro.syberia.display.version")
  ...
  if OPTIONS.backuptool:
    ...
    if is_system_as_root:
      script.fstab["/system"].mount_point = system_mount_point
    script.Mount("/system")
    script.RunBackup("restore", "/system/system" if is_system_as_root and common.system_as_system else "/system")
    script.Unmount(system_mount_point)
    if is_system_as_root:
      script.fstab["/system"].mount_point = "/"
